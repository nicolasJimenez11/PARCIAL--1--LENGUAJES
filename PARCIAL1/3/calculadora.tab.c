...
enum yysymbol_kind_t
{
  ...
  YYSYMBOL_lineas = 14,                    /* lineas  */
  YYSYMBOL_linea = 15,                     /* linea  */
...
{
  "\"end of file\"", "error", "\"invalid token\"", "NUM", "SQRT", "'+'",
  "'-'", "'*'", "'/'", "'\\n'", "'('", "')'", "$accept", "inicio",
  "lineas", "linea", "expr", YY_NULLPTR
};
...
{
      -2,    -8,    -7,    -8,    10,     4,    -2,    -8,    25,    10,
      11,    -8,    -8,    10,    10,    10,    10,    -8,    18,    -8,
      20,    20,    -8,    -8,    -8
};
...
{
      10,     1,     2,     9,    11,    18,    12,     3,     4,    20,
      21,    22,    23,     1,     2,     0,    13,    14,    15,    16,
       4,     0,    19,    13,    14,    15,    16,    15,    16,    24,
      13,    14,    15,    16,    17
};

static const yytype_int8 yycheck[] =
{
       4,     3,     4,    10,     0,     9,     6,     9,    10,    13,
      14,    15,    16,     3,     4,    -1,     5,     6,     7,     8,
      10,    -1,    11,     5,     6,     7,     8,     7,     8,    11,
       5,     6,     7,     8,     9
};
...
{
       0,     3,     4,     9,    10,    13,    14,    15,    16,    10,
      16,     0,    15,     5,     6,     7,     8,     9,    16,    11,
      16,    16,    16,    16,    11
};
